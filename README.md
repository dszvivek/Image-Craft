# 🔧 ImagePlumber - Privacy-First Local Image Tools Suite

ImagePlumber is a modern, responsive, and 100% client-side web application offering a suite of 12 powerful image manipulation and local AI utilities. All file transformations, compression, text extraction, and background removals are executed **entirely in your browser's memory** via WebAssembly (WASM), Web Workers, and ONNX Runtime Web. Your image bytes never leave your device.

🌐 **Live Demo:** [imageplumber.com](https://imageplumber.com)

---

## 🚀 Key Features (17 Tools)
...
- **Electronic PDF Signer:** Sign PDF documents on-device with drawn, typed, or uploaded signature overlays.
- **PDF Bank Statement Analyzer:** Parse and audit credit card & bank statements to CSV/Excel spreadsheets offline.
- **AI Shape Art Generator:** Transform portraits into particle clouds, stars, or sketches.
- **Photo Mosaic Generator:** Recreate master images from thousands of small photo tiles in memory.
- **Ambient Generative Visuals:** Continuously evolving ambient visuals for focus, relaxation, and break timers.
...
ImagePlumber runs **zero backend servers**. All operations are processed locally in your browser cache. You can verify this assertion by opening your browser's Developer Tools (F12) > **Network** tab, dropping an image file, and observing that no image bytes or uploads are generated.
