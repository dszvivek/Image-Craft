# ImagePlumber - Deployment & Hosting Guide

ImagePlumber is designed as a zero-backend, client-side React application that runs entirely in the browser. It can be built statically and deployed to any static site hosting provider, with **Cloudflare Pages** being the recommended platform.
...
1. **AdSense Application:**
   Add `imageplumber.com` in your Google AdSense console and submit for site approval.
