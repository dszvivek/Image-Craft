...
export const Faq: React.FC = () => {
  ...
  const faqs: FAQItem[] = [
    ...
    },
    {
      ...
      a: 'Absolutely not. ImagePlumber has no databases, telemetry tracking, or backend servers for your files. All transformations, AI cutouts, and OCR script scanning occur locally in your browser memory (RAM).'
    },
    {
    ...
    {
      q: 'Is ImagePlumber truly 100% free?',
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="premium-bento rounded-3xl p-8 bg-gradient-to-tr from-indigo-50/40 via-white to-purple-50/40 border border-slate-200/50 shadow-xs flex flex-col md:flex-row items-center gap-6 justify-between text-left">
          <div className="space-y-2">
            ...
            <p className="font-extrabold text-lg text-slate-900">Have a privacy question not listed here?</p>
