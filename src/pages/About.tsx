        ...
        <section className="space-y-6 pt-6 border-t border-slate-200/60">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={index} 
                className="premium-bento p-6 rounded-3xl bg-white border border-slate-200/50 flex flex-col justify-between gap-4 hover:scale-[1.01] transition-transform shadow-xs"
              >
                {/* Star rating */}
                ...
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold border border-slate-250/50 ${test.avatarColor}`}>
                    {test.initials}
                  </div>
                  <div>
