...
export const SvgVectorizer: React.FC = () => {
  ...
  const vectorSchema = {
    ...
    'name': 'SVG Vectorizer - ImagePlumber',
      ...
      <div className="max-w-5xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 flex flex-col justify-between w-full shadow-sm hover:border-teal-350 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How SVG Vectorizer Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Online vector tools have recently started charging fees or placing pixel limitations on SVG exports. ImagePlumber vectorizes your logo PNGs and JPEGs completely locally. Experience limitless traces and download clean SVGs with zero subscriptions.'
          }}
          steps={[
            {
              title: 'Upload Image',
