...
export const WatermarkOverlay: React.FC = () => {
  ...
  const [watermarkText, setWatermarkText] = useState<string>('ImagePlumber');
  ...
  const watermarkSchema = {
    ...
    'name': 'Watermark Overlay - ImagePlumber',
      ...
      <div className="max-w-5xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 flex flex-col justify-between w-full shadow-sm hover:border-rose-350 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How Watermark Overlay Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Most cloud watermark tools limit photo exports, add their own forced logo watermarks, or charge fees for batch sizes. ImagePlumber runs watermark overlays inside your browser Canvas runtime memory. Your pictures are signed locally without any external data uploads.'
          }}
          steps={[
            {
          ...
          faq={[
            ...
            {
              q: 'Does ImagePlumber add its own watermark?',
