        ...
        {!file ? (
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch max-w-5xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 bg-white border border-slate-200/50 flex flex-col justify-between w-full shadow-sm hover:border-rose-300 transition-all duration-300">
                <div className="space-y-4">
                  <div className="text-[10px] font-bold text-rose-650 bg-rose-50/50 border border-rose-100/60 px-2 py-0.5 rounded uppercase tracking-wider inline-block">Demo Preview</div>
              ...
              <div className="premium-bento p-6 rounded-3xl bg-white space-y-6 shadow-xs">
                ...
                {watermarkType === 'text' ? (
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-semibold text-slate-750 focus:outline-none focus:border-indigo-500 transition-all"
                  ...
                  <div className="space-y-4">
                    ...
                    {!logoFile ? (
                      <label className="border border-dashed border-slate-250 hover:border-indigo-550/50 hover:bg-slate-50 py-4 px-3 rounded-2xl flex flex-col items-center justify-center gap-1.5 cursor-pointer text-center transition-all">
                      ...
                      <div className="flex items-center justify-between p-3.5 bg-slate-50 border border-slate-200 rounded-2xl shadow-xs">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-semibold text-slate-700 focus:outline-none focus:border-indigo-500 transition cursor-pointer"
                  >
