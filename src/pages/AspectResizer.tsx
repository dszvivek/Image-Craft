...
export const AspectResizer: React.FC = () => {
  ...
  const handleDownload = () => {
    ...
    const ext = lastDot > 0 ? file.name.substring(lastDot) : '.png';
  ...
  const aspectSchema = {
    ...
    'name': 'Smart Crop & Aspect Resizer - ImagePlumber',
      ...
      <div className="max-w-5xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 bg-white border border-slate-200/50 flex flex-col justify-between w-full shadow-sm hover:border-amber-300 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How Aspect Resizer Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Standard resizers upload photos to their backend or restrict custom ratios to premium plans. ImagePlumber resizes all images in your browser RAM, featuring on-device face and document boundary detection completely free.'
          }}
          steps={[
            {
              title: 'Upload Photo',
