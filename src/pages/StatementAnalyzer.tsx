...
export const StatementAnalyzer: React.FC = () => {
  ...
  const analyzerSchema = {
    ...
    'name': 'PDF Bank Statement Analyzer - ImagePlumber',
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!statementInfo && !isProcessing && isScannedPdf && (
          <div className="glass-card p-8 rounded-3xl border border-amber-200 bg-amber-50/10 flex flex-col items-center justify-center text-center gap-5 max-w-2xl mx-auto shadow-sm animate-fade-in">
            ...
            <div className="space-y-2">
              <p className="text-lg font-extrabold text-slate-900">Scanned Document Detected</p>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Most banking parsing web apps command cloud databases, uploading your statement PDF records containing card numbers, home addresses, and spend behavior to third-party endpoints. ImagePlumber executes all parsing algorithms locally on client-side JS. No servers, no data exports.'
          }}
          steps={[
            {
