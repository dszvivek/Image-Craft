...
export const BatchConverter: React.FC<BatchConverterProps> = ({
        ...
        img.onload = () => {
          if (format === 'application/pdf') {
            try {
              ...
              const lastDot = batchFile.file.name.lastIndexOf('.');
              const origName = lastDot > 0 ? batchFile.file.name.substring(0, lastDot) : batchFile.file.name;
  ...
  const batchSchema = {
    ...
    'name': 'Batch Image Converter - ImagePlumber',
      ...
      <div className="max-w-5xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 bg-white border border-slate-200/50 flex flex-col justify-between w-full shadow-sm hover:border-indigo-300 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How Batch Converter Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Unlike traditional online PDF compilers and converters that upload your private photos to external servers, ImagePlumber executes all conversions directly inside your browser memory. This guarantees 100% data privacy, zero file size limits, and instant local compilation.'
          }}
          steps={[
            {
          ...
          faq={[
            ...
            },
            {
              ...
              a: 'Yes, absolutely. ImagePlumber compiles and converts all files locally using JavaScript (jsPDF and HTML5 Canvas). No files are uploaded, stored, or processed on any backend server, keeping your private documents completely secure.'
            }
          ]}
        />
