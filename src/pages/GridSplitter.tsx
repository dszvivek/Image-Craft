...
export const GridSplitter: React.FC = () => {
  ...
  const handleDownloadAll = async () => {
    ...
    img.onload = async () => {
      ...
      link.href = url;
      link.download = `${baseName}_${gridSize}x${gridSize}_grid.zip`;
  ...
  const gridSchema = {
    ...
    'name': 'Instagram Grid Splitter - ImagePlumber',
      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 bg-white border border-slate-200/50 flex flex-col justify-between w-full shadow-sm hover:border-indigo-300 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How Grid Splitter Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Most grid splitter apps force ads, require account registrations, or place ugly watermarks on your slices unless you pay. ImagePlumber splits your photos locally in high resolution, completely free, offline, and with absolutely no watermarks.'
          }}
          steps={[
            {
              title: 'Upload Photo',
