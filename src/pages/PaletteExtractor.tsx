...
export const PaletteExtractor: React.FC = () => {
  ...
  const downloadJSON = () => {
    ...
    link.href = dataStr;
    link.download = `${baseName}_palette.json`;
  ...
  const downloadCSS = () => {
    ...
    const link = document.createElement('a');
    link.href = url;
    link.download = `${baseName}_palette.css`;
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
  ...
  const downloadPNGSwatch = () => {
    ...
    canvas.toBlob((blob) => {
      if (blob) {
        ...
        const link = document.createElement('a');
        link.href = url;
        link.download = `${baseName}_palette.png`;
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
        URL.revokeObjectURL(url);
  ...
  const paletteSchema = {
    ...
    'name': 'Color Palette Extractor - ImagePlumber',
      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 flex flex-col justify-between w-full shadow-sm hover:border-indigo-350 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How Palette Extractor Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Most cloud-based palette generators limit export formats behind premium memberships or process uploads on remote databases. ImagePlumber extracts color swatches inside your browser window. Copy HEX, RGB, or HSL codes instantly, and export structured color tokens with zero logins.'
          }}
          steps={[
            {
              title: 'Upload Image',
