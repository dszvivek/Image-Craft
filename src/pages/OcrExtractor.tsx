...
export const OcrExtractor: React.FC = () => {
  ...
  const ocrSchema = {
    ...
    'name': 'OCR Text Extractor - ImagePlumber',
      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 flex flex-col justify-between w-full shadow-sm hover:border-indigo-350 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How OCR Text Extractor Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Standard online OCR services upload your sensitive scanned documents, receipts, or personal screenshots directly to cloud databases. ImagePlumber utilizes Tesseract.js client-side scripts. Everything executes on your CPU locally, meaning your data never leaves your computer.'
          }}
          steps={[
            {
