...
export const Compressor: React.FC<CompressorProps> = ({
  ...
  const compressorSchema = {
    ...
    'name': 'Image Compressor - ImagePlumber',
      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="md:col-span-5 flex">
              <div className="premium-bento rounded-3xl p-6 bg-white border border-slate-200/50 flex flex-col justify-between w-full shadow-sm hover:border-indigo-300 transition-all duration-300">
                <div className="space-y-4">
                  ...
                  <h2 className="text-base font-extrabold text-slate-900">How Compressor Works</h2>
        ...
        <ToolGuide
          ...
          competitorComparison={{
            ...
            benefit: 'Unlike online services that upload your files to external cloud servers, ImagePlumber compresses all images directly inside your browser cache. Zero kilobytes are uploaded, and files are processed instantly with zero cost and no subscription barriers.'
          }}
          steps={[
            {
              title: 'Upload Image',
